...
app.get('/js/config.js', (req, res) => {
  ...
  // No-cache: this file is regenerated by admin settings and must never be
  // served from a stale browser cache (a cached broken regen caused a
  // "hexToRgb undefined" crash + invisible footer). Force revalidation each load.
